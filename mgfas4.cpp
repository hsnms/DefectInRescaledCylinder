...
#include <math.h>
#define NPRE 30 
#define NPOST /*1300*//**1000*//*1000*//*5000*/1300
#define ALPHA 0.33
#define NGMAX 15
...
#include "Header3.h"
#include "Header4.h"
void mgfas4(double **u, int n, int maxcyc, double m, int a,int b, double *q, double *x, double *y, double R0, double K)
{
	int j,i,jpost,lsw,jsw,ipass; 
	double h,res,v1,v2,v3,v4,v5,v6,v7,v8,v9,H,h2i,foh2,rjac,omega=1.0;
	H=1.0;
	h=1.0/(n-1); 
	h2i=1.0/(h*h);
	foh2=-4.0*h2i;
	
	rjac=/*0.9999*//*0.999*//*0.5*/0.99;
