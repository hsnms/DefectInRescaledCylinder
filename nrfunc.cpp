...
f[n][1]=pow(sin(u[n][1]),2)/(1.0*(n-1)*h)+sin(2.0*u[n][1])*(u[n][1]-u[n-1][1])/(1.0*h)-2.0*pow(sin(u[n][1]),2)*q[j]*(u[n][2]-u[n][1])/(1.0*h)+(1.0*(n-1)*h)*pow((u[n][1]-u[n-1][1])/(1.0*h),2)+(1.0*(n-1)*h)*pow(q[j],2)*pow((u[n][2]-u[n][1])/(1.0*h),2);
	...
	/* v1=u[1][2]-u[1][1];
			...
			v9=q[2]-q[1];		       
			i=1;j=1;
		f[1][1]=((K*pow(cos(u[i][j]),2)+1.0*pow(sin(u[i][j]),2))*(i-1)+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),3)*0.25*pow(v8+v9,2)+(K-1.0)*sin(2.0*u[i][j])*pow(1.0*(i-1),2)*0.5*(v8+v9))*pow(v4+v5,2)/(4.0*h)
				+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*(i-1)*pow(q[j]*(v1+v2),2)/(4.0*h)-((K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),2)*(v8+v9)*q[j]+(K-1.0)*sin(2.0*u[i][j])*(i-1)*q[j])*(v1+v2)*(v4+v5)/(4.0*h)
				+(K*sin(2.0*u[i][j])-K*(cos(2.0*u[i][j])-1.0)*(i-1)*0.5*(v8+v9))*(v4+v5)/(2.0*h)+K*(cos(2.0*u[i][j])-1.0)*q[j]*(v1+v2)/(2.0*h);
			...
			v9=q[n]-q[n-1];		       
			i=1;j=n;
		f[1][n]=((K*pow(cos(u[i][j]),2)+1.0*pow(sin(u[i][j]),2))*(i-1)+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),3)*0.25*pow(v8+v9,2)+(K-1.0)*sin(2.0*u[i][j])*pow(1.0*(i-1),2)*0.5*(v8+v9))*pow(v4+v5,2)/(4.0*h)
				+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*(i-1)*pow(q[j]*(v1+v2),2)/(4.0*h)-((K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),2)*(v8+v9)*q[j]+(K-1.0)*sin(2.0*u[i][j])*(i-1)*q[j])*(v1+v2)*(v4+v5)/(4.0*h)
				+(K*sin(2.0*u[i][j])-K*(cos(2.0*u[i][j])-1.0)*(i-1)*0.5*(v8+v9))*(v4+v5)/(2.0*h)+K*(cos(2.0*u[i][j])-1.0)*q[j]*(v1+v2)/(2.0*h);
			...
			v9=q[2]-q[1];		        
			i=n;j=1;
		f[n][1]=K*pow(sin(u[i][j]),2)/(h*(i-1))+((K*pow(cos(u[i][j]),2)+1.0*pow(sin(u[i][j]),2))*(i-1)+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),3)*0.25*pow(v8+v9,2)+(K-1.0)*sin(2.0*u[i][j])*pow(1.0*(i-1),2)*0.5*(v8+v9))*pow(v4+v5,2)/(4.0*h)
				+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*(i-1)*pow(q[j]*(v1+v2),2)/(4.0*h)-((K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),2)*(v8+v9)*q[j]+(K-1.0)*sin(2.0*u[i][j])*(i-1)*q[j])*(v1+v2)*(v4+v5)/(4.0*h)
				+(K*sin(2.0*u[i][j])-K*(cos(2.0*u[i][j])-1.0)*(i-1)*0.5*(v8+v9))*(v4+v5)/(2.0*h)+K*(cos(2.0*u[i][j])-1.0)*q[j]*(v1+v2)/(2.0*h);
			...
			v9=q[n]-q[n-1];		        
			i=n;j=n;
		f[n][n]=K*pow(sin(u[i][j]),2)/(h*(i-1))+((K*pow(cos(u[i][j]),2)+1.0*pow(sin(u[i][j]),2))*(i-1)+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),3)*0.25*pow(v8+v9,2)+(K-1.0)*sin(2.0*u[i][j])*pow(1.0*(i-1),2)*0.5*(v8+v9))*pow(v4+v5,2)/(4.0*h)
				+(K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*(i-1)*pow(q[j]*(v1+v2),2)/(4.0*h)-((K*pow(sin(u[i][j]),2)+1.0*pow(cos(u[i][j]),2))*pow(1.0*(i-1),2)*(v8+v9)*q[j]+(K-1.0)*sin(2.0*u[i][j])*(i-1)*q[j])*(v1+v2)*(v4+v5)/(4.0*h)
				+(K*sin(2.0*u[i][j])-K*(cos(2.0*u[i][j])-1.0)*(i-1)*0.5*(v8+v9))*(v4+v5)/(2.0*h)+K*(cos(2.0*u[i][j])-1.0)*q[j]*(v1+v2)/(2.0*h);
	
		*/
	for (i=n-(n-1)/(m-1);i<=n;i++)
		for (j=n-(int)(q[1]*(n-1)/(m-1));j<=n;j++)
			f[i][j]=0.0;
	if (a>=1&&a<=(n-1)/(m-1))
	{
		for (i=1;i<=1+(n-1)/(m-1);i++)
			for (j=1;j<=1+(int)(q[1]*(n-1)/(m-1));j++)
				f[i][j]=0.0;
				
	}
	else if (a>=1+(n-1)/(m-1)&&a<=n-(n-1)/(m-1))
		{
		for (i=a-(n-1)/(m-1);i<=a+(n-1)/(m-1);i++)
			for (j=1;j<=1+(int)(q[1]*(n-1)/(m-1));j++)
				f[i][j]=0.0;
